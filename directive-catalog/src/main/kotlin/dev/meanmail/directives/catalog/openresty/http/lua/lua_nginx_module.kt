...
import dev.meanmail.directives.catalog.nginx.http.`if` as ifDirective
...
val accessByLua = Directive(
    ...
    context = listOf(http, ifDirective, location, server),
...
val contentByLua = Directive(
    ...
    context = listOf(ifDirective, location),
    module = lua_nginx_module
)
...
val luaUpstreamSkipOpensslDefaultVerify = Directive(
    ...
    parameters = listOf(
        DirectiveParameter(
            name = "value",
            description = "Toggle for skipping OpenSSL's default upstream verification",
    ...
    context = listOf(location, ifDirective),
    module = lua_nginx_module
)
...
val setByLua = Directive(
    ...
    context = listOf(ifDirective, location, server),
    module = lua_nginx_module
)
